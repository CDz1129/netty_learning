...
/**
 * Protobuf type {@code com.cdz.proto.StudentResponseList}
 */
public  final class StudentResponseList extends
    com.google.protobuf.GeneratedMessageV3 implements
    // @@protoc_insertion_point(message_implements:com.cdz.proto.StudentResponseList)
...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              studentList_ = new java.util.ArrayList<StudentResponse>();
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return StudentProto.internal_static_com_cdz_proto_StudentResponseList_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return StudentProto.internal_static_com_cdz_proto_StudentResponseList_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            StudentResponseList.class, Builder.class);
  }

  public static final int STUDENTLIST_FIELD_NUMBER = 1;
  private java.util.List<StudentResponse> studentList_;
  /**
   * <code>repeated .com.cdz.proto.StudentResponse studentList = 1;</code>
   */
  public java.util.List<StudentResponse> getStudentListList() {
    return studentList_;
  }
  /**
   * <code>repeated .com.cdz.proto.StudentResponse studentList = 1;</code>
   ...
   * <code>repeated .com.cdz.proto.StudentResponse studentList = 1;</code>
   */
  public StudentResponse getStudentList(int index) {
    return studentList_.get(index);
  }
  /**
   * <code>repeated .com.cdz.proto.StudentResponse studentList = 1;</code>
   */
  public StudentResponseOrBuilder getStudentListOrBuilder(
      int index) {
    return studentList_.get(index);
  }
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:com.cdz.proto.StudentResponseList)
      StudentResponseListOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return StudentProto.internal_static_com_cdz_proto_StudentResponseList_descriptor;
    ...
    // Construct using com.cdz.netty.proto.StudentResponseList.newBuilder()
    private Builder() {
    ...
    private void ensureStudentListIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        studentList_ = new java.util.ArrayList<StudentResponse>(studentList_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        StudentResponse, StudentResponse.Builder, StudentResponseOrBuilder> studentListBuilder_;
     ...
     * <code>repeated .com.cdz.proto.StudentResponse studentList = 1;</code>
     */
    public Builder addStudentList(StudentResponse value) {
      if (studentListBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     * <code>repeated .com.cdz.proto.StudentResponse studentList = 1;</code>
     */
    public StudentResponse.Builder getStudentListBuilder(
        int index) {
     ...
     * <code>repeated .com.cdz.proto.StudentResponse studentList = 1;</code>
     */
    public StudentResponse.Builder addStudentListBuilder() {
    ...
    // @@protoc_insertion_point(builder_scope:com.cdz.proto.StudentResponseList)
  }

  // @@protoc_insertion_point(class_scope:com.cdz.proto.StudentResponseList)
